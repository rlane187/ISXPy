...
bool __cdecl TLO_Py(int argc, char *argv[], LSTYPEVAR &Dest)
{
	// argc and argv are used if the object access uses an index, such as Py[1] or 
	// Py[my coat,1,seventeen].  argc is the number of parameters (or dimensions) separated 
