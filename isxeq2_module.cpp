...
BOOST_PYTHON_MODULE(isxeq2)
{
	...
	class_<eq2_actor, bases<ls_object>>("actor")
		...
		.def("get_actor", &eq2_actor::from_id)
		.def("get_actor", &eq2_actor::from_query)
		.add_property("name_lso", &eq2_actor::get_name_lso);
	...
	class_<py_eq2_character, bases<eq2_actor>>("character")
